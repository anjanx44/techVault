...
public class User {
    ...
    public User(Long id, String username, String password, String email, String firstName, String lastName, Set<Role> roles, List<Post> posts, List<Comment> comments) {
        this.id = id;
